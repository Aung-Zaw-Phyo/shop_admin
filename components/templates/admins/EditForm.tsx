...
import { Admin } from '@/components/columns/admin-columns';
import { updateAdmin } from '@/app/(dashboard)/admins/_action';
...
const CreateForm = ({ admin }: { admin: Admin }) => {
    let [state, formAction] = useServerFormState(updateAdmin, null);
        ...
        <form onSubmit={handleSubmit(submit)} encType="multipart/form-data">
            ...
            <div className='mb-4'>
                <label htmlFor="image" className='cursor-pointer inline-block'>
                    ...
                    {
                        !imagePreview && !admin.image && <div className='w-[130px] h-[130px] border-2 border-dotted rounded p-1 flex flex-col justify-center items-center'>
